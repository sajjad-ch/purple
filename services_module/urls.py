...
urlpatterns = [
    ...
    path('visits/select-supservice/<int:artist_id>/<int:service_id>/', GetSupserviceFromArtistAndService.as_view(), name='supservice-artist-service'),
    path('visits/select-service/<int:artist_id>/', GetServiceFromArtist.as_view(), name='service-artist'),
