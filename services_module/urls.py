...
urlpatterns = [
    ...
    path('highlight_media_update/<int:media_id>/', UpdateMediaHighlightView.as_view(), name='media-update'),
    path('check_thumbnail/<int:highlight_id>/', LastMediaThumbnailView.as_view(), name='check-thumbnail'),
