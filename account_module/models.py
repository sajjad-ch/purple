...
class SaloonModel(models.Model):
    ...
    latitude = models.DecimalField(max_digits=9, decimal_places=7, blank=True, null=True, verbose_name='طول جغرافیایی')   # TODO: these two fields must be migrated.
    longitude = models.DecimalField(max_digits=9, decimal_places=7, blank=True, null=True, verbose_name='عرض جغرافیایی')
